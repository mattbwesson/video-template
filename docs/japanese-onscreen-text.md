...
- **Word order.** Some kinetic scenes split a sentence across slots that animate separately. Those rows are fragments, and a **Reads as** line under the table shows what they build — judge the sentence, not the fragments.

Two notes in the third column:

- *location inferred* — the screen is a best guess from where the English appears, not a resolved call site. The Japanese is right; the grouping might not be.
- *overridden on X* — this word means something else on screen X, which has its own entry prefixed `X/`. The two are not in conflict.

696 strings across 59 screens.

### HeadquartersScene · frames 33–139 (0:01.3–0:05.6)
...
### WorkvivoMobileHome · frames 417–600 (0:16.7–0:24.0)
...
| Pages | ページ |  |
| Podcasts | ポッドキャスト |  |
| Survey & Forms | サーベイ・フォーム |  |
| Surveys & Forms | サーベイ・フォーム |  |
| Newsletters | ニュースレター |  |
| Journeys | ジャーニー |  |
| CONNECT | つながる |  |
| Connect | つながる |  |
...
| English | Japanese | |
|---|---|---|
| Go Live | ライブ配信 | location inferred |
...
| Everyone | 全員 |  |
| Post | 投稿 |  |
| Video | 動画 | location inferred |
| Image | 画像 | location inferred |
| Add | 追加 |  |
| OK | OK |  |
| Ask a Question | 質問する |  |
...
| Normal Text | 標準テキスト |  |
| Translations | 翻訳 | location inferred |
| Attachment | 添付 | location inferred |
| Poll | 投票 | location inferred |
| Campaign | キャンペーン | location inferred |
| Tag | タグ | location inferred |
| Value | 価値観 | location inferred |
...
| English | Japanese | |
|---|---|---|
| Key Business Results | 主要な事業成果 | location inferred |

### WorkvivoLiveReplay · frames 1275–1477 (0:51.0–0:59.1)
...
| Joined | 参加済み |  |
| Join | 参加 |  |
| Request to Join | 参加をリクエスト | location inferred |
...
| Start | 開始 |  |
| Documents | ドキュメント |  |
| Published 1 week ago | 1週間前に公開 | location inferred |
| Published 4 days ago | 4日前に公開 | location inferred |
| AUG | 8月 |  |
| View Event | イベントを見る |  |
...
| English | Japanese | |
|---|---|---|
| Share a Message | メッセージを共有 | location inferred |
| Create a custom message | カスタムメッセージを作成 | location inferred |
| Share Org Chart | 組織図を共有 | location inferred |
| Share your companies structure | 会社の組織構成を共有 | location inferred |
| Share an Update | アップデートを共有 | location inferred |
| Share an existing update | 既存のアップデートを共有 | location inferred |
| Share Values | 価値観を共有 | location inferred |
| Share your companies values | 会社の価値観を共有 | location inferred |
| Enroll to a Space | スペースに登録 | location inferred |
| Automatically add to a space | スペースに自動で追加 | location inferred |
| Share an Article | 記事を共有 | location inferred |
| Share and existing article | 既存の記事を共有 | location inferred |
| Share a Page | ページを共有 | location inferred |
| Share existing page | 既存のページを共有 | location inferred |
| Share a Link | リンクを共有 | location inferred |
| Share any URL | 任意のURLを共有 | location inferred |
| Share a Survey | サーベイを共有 | location inferred |
| Share an existing survey | 既存のサーベイを共有 | location inferred |
| Assign a Badge | バッジを付与 | location inferred |
| Reward with a badge | バッジで称える | location inferred |
...
| English | Japanese | |
|---|---|---|
| A message has been shared with you | メッセージが共有されました | location inferred |
| A page has been shared with you | ページが共有されました | location inferred |
| A survey has been shared with you | サーベイが共有されました | location inferred |
| An article has been shared with you | 記事が共有されました | location inferred |
| You have been enrolled in a space | スペースに登録されました | location inferred |
| View your companies values | 会社の価値観を見る | location inferred |
| Not Started | 未開始 |  |
| Started | 開始済み |  |
...
| English | Japanese | |
|---|---|---|
| Amplify | 広げる | location inferred |
| Reach | 届ける | location inferred |
...
| Partly Cloudy | 晴れ時々曇り | location inferred |

### WorkvivoNewsletters · frames 1978–2058 (1:19.1–1:22.3)
...
| Options | オプション |  |
| All | すべて |  |
| June 10, 2026 12.00AM | 2026年6月10日 0:00 | location inferred |
| June 11, 2026 11.00AM | 2026年6月11日 11:00 | location inferred |
| June 12, 2026 10.00AM | 2026年6月12日 10:00 | location inferred |
| June 17, 2026 10:00AM | 2026年6月17日 10:00 | location inferred |
...
### WorkvivoTopbar · frames 1978–2058 (1:19.1–1:22.3), frames 4066–4110 (2:42.6–2:44.4), frames 4553–4591 (3:02.1–3:03.6)
...
| Content | コンテンツ |  |
| Design | デザイン |  |
| Full Width | 全幅 | location inferred |
| One Third | 1/3 | location inferred |
| Two Thirds | 2/3 | location inferred |
| Heading | 見出し | location inferred |
| Heading text | 見出しテキスト |  |
| Text | テキスト | location inferred |
| Button | ボタン |  |
| Hero | ヒーロー | location inferred |
| Spacer | スペーサー | location inferred |
| Divider | 区切り線 | location inferred |
| Update | アップデート | location inferred |
...
| Sort By | 並び替え |  |
| Most Relevant | 関連度順 |  |
| Date | 日付 | location inferred |
| Created By | 作成者 | location inferred |
| Space | スペース | location inferred |
| Team | チーム | location inferred |
...
| 6.3 MB | 6.3 MB |  |
| Share Point | SharePoint | location inferred |
| Time Off | 休暇 | location inferred |
| the | 先へ。 | location inferred |
...
### WorkvivoHqChat · frames 2392–2499 (1:35.7–1:40.0)
...
| English | Japanese | |
|---|---|---|
| they | 今 | overridden on nomatter; location inferred |
| nomatter/No | どこに |  |
| nomatter/matter | いても |  |
| nomatter/where | つながる |  |
| nomatter/they |  |  |
...
| Discover | 見つける |  |
| Media | メディア | location inferred |
| See all widgets | すべてのウィジェット |  |
| View Widgets | ウィジェットを見る |  |
| Shortcuts, apps, docs, and journeys. | ショートカット、アプリ、ドキュメント、ジャーニー。 | location inferred |
| Podcasts, video, and embeds. | ポッドキャスト、動画、埋め込み。 | location inferred |
| News, events, announcements, and more. | ニュース、イベント、お知らせなど。 | location inferred |
| Spaces and people in motion. | スペースとメンバーの動き。 | location inferred |
| Skills and serialized learning. | スキルと段階的な学習。 | location inferred |
| Time off, weather, live data. | 休暇、天気、ライブデータ。 | location inferred |
| Make your landing page feel alive. | ランディングページに動きを。 |  |
| Integrations | 連携 | location inferred |
...
| Connect | つながる |  |
| Learn | 学ぶ |  |
| Podcast | ポッドキャスト | location inferred |
| Productivity | 生産性 |  |
| Stay Informed | 最新情報 |  |
| Technical | テクニカル |  |
| Time Off | 休暇 | location inferred |
| Access your most important resources and tools instantly with customizable shortcuts. | よく使うリソースやツールに、カスタマイズできるショートカットからすぐにアクセス。 | location inferred |
| Apps provides you with instant access to essential productivity tools. | 業務に欠かせないツールにすぐアクセスできます。 | location inferred |
| Billboards serve as a platform for promoting and showcasing your desired content. | ビルボードは、伝えたいコンテンツを発信・紹介するためのプラットフォームです。 | location inferred |
| Catch up on the latest episodes from your favorite shows and discover new content. | お気に入り番組の最新エピソードをチェックし、新しいコンテンツに出会えます。 | location inferred |
| Explore curated pages and resources handpicked for your team and interests. | チームや関心に合わせて選ばれたページやリソースを探せます。 | location inferred |
| Get the latest updates and announcements from across your organization in one place. | 全社の最新情報とお知らせをひとつの場所で。 | location inferred |
| Join the conversation in the most active community spaces. | 最も活発なコミュニティスペースの会話に参加しましょう。 | location inferred |
| Stay updated , designed to keep you informed about all the exciting activities on the horizon. | これから予定されているイベントや活動を見逃さないために。 | location inferred |
| Stay updated with the latest posts in your activity feed. | アクティビティフィードの最新の投稿をチェック。 | location inferred |
| Track your vacation days and plan your next break to recharge and stay balanced. | 休暇の残日数を確認し、次の休みを計画してリフレッシュを。 | location inferred |
...
| Video | 動画 | location inferred |
| Image | 画像 | location inferred |
| Heading 1 | 見出し1 | location inferred |
| Heading 2 | 見出し2 | location inferred |
| Heading 3 | 見出し3 | location inferred |
| List | リスト | location inferred |
| Embed | 埋め込み | location inferred |
| Table | 表 | location inferred |
| Callout | コールアウト | location inferred |
...
| Untitled | 無題 |  |
| Normal | 標準 | location inferred |
| English | 英語 | location inferred |
| Heading 1 | 見出し1 | location inferred |
| Heading 2 | 見出し2 | location inferred |
| Heading 3 | 見出し3 | location inferred |
| List | リスト | location inferred |
...
| All | すべて |  |
| Campaigns | キャンペーン | location inferred |
| Analytics & Reporting | 分析とレポート |  |
| Snapshot | スナップショット | location inferred |
| Activation | アクティベーション | location inferred |
| Advanced Usage | 詳細な利用状況 | location inferred |
| Advanced Content | 詳細なコンテンツ | location inferred |
| Governance | ガバナンス | location inferred |
| Activity Feed | アクティビティフィード |  |
| Bookmarks | ブックマーク | location inferred |
| Following | フォロー中 | location inferred |
| Recent Updates | 最近の更新 | location inferred |
| Reported | 報告済み | location inferred |
| Activation Rate | アクティベーション率 | location inferred |
| Onboarding Rate | オンボーディング率 | location inferred |
| Mobile App Users | モバイルアプリ利用者 | location inferred |
| Profile Picture Upload | プロフィール写真の設定 | location inferred |
| Profile | プロフィール |  |
| Monthly Active Users | 月間アクティブユーザー | location inferred |
| Weekly Active Users | 週間アクティブユーザー | location inferred |
| Daily Active Users | 日間アクティブユーザー | location inferred |
| % of Monthly Active over Time users | 月間アクティブユーザーの推移（%） | location inferred |
| Shown as % active users in selected time period | 選択期間のアクティブユーザー率で表示 | location inferred |
| Date From | 開始日 |  |
| Date To | 終了日 | location inferred |
| Primary Team | 主担当チーム | location inferred |
| Secondary Team | 副担当チーム | location inferred |
| Tertiary Team | 第三チーム | location inferred |
| Revert to Old Version | 旧バージョンに戻す |  |
| Jan 2026 | 2026年1月 | location inferred |
| Feb 2026 | 2026年2月 | location inferred |
| Mar 2026 | 2026年3月 | location inferred |
| Apr 2026 | 2026年4月 | location inferred |
| May 2026 | 2026年5月 | location inferred |
| Jun 2026 | 2026年6月 | location inferred |
| Dec 1, 2025 | 2025年12月1日 | location inferred |
| Dec 7, 2025 | 2025年12月7日 | location inferred |
| Jan 1, 2026 | 2026年1月1日 | location inferred |
| Feb 1, 2026 | 2026年2月1日 | location inferred |
| Mar 1, 2026 | 2026年3月1日 | location inferred |
| Apr 1, 2026 | 2026年4月1日 | location inferred |
| May 1, 2026 | 2026年5月1日 | location inferred |
| Jun 1, 2026 | 2026年6月1日 | location inferred |
| Jun 14, 2026 | 2026年6月14日 | location inferred |
...
| Drivers | ドライバー | location inferred |
| Values | 価値観 | location inferred |
| Radar | レーダー | location inferred |

### WorkvivoSeerManagerInsights · frames 3758–3794 (2:30.3–2:31.8)
...
| Overview | 概要 |  |
| Metrics | 指標 |  |
| Score | スコア | location inferred |
| Score Change | スコアの変化 |  |
| Completion Rate | 完了率 |  |
| Response Rate | 回答率 |  |
| Completions | 完了 | location inferred |
...
| Upcoming Events | 今後のイベント |  |
| UPCOMING EVENTS | 今後のイベント |  |
| Members | メンバー | location inferred |
| Join | 参加 |  |
| Global | グローバル |  |
| Share | 共有 |  |
| Reply | 返信 |  |
...
| HR & People | 人事・メンバー | location inferred |
| IT & Support | IT・サポート | location inferred |
| IT & Support Integrations | IT・サポートの連携 | location inferred |
| Social Media | ソーシャルメディア | location inferred |
| Add Social Media Integrations | ソーシャルメディア連携を追加 | location inferred |
| Add Payrolls, HR and other people Integrations | 給与・人事などの連携を追加 | location inferred |
| Get a  from your provider/Calendar Integrations | カレンダー連携を追加 | location inferred |
...
| Setup | 設定 |  |
| Active | 有効 |  |
| Content Search | コンテンツ検索 | location inferred |
| People Directory | メンバー一覧 | location inferred |
| Productivity | 生産性 |  |
| Calendar | カレンダー |  |
| Apple Calendar | Apple カレンダー | location inferred |
| Yahoo Calendar | Yahoo カレンダー | location inferred |
| IT Service Management | ITサービス管理 | location inferred |
| Gmail, Drive, Calendar, | Gmail、ドライブ、カレンダー、 | location inferred |
| Outlook Mail, Outlook Calendar, MS Teams Chat, Sharepoint +5 | Outlook メール、Outlook 予定表、Teams チャット、SharePoint ほか5件 | location inferred |
| Quick Access widget, Zoom Mail, Zoom Calendar, Zoom Whiteboards +2 | クイックアクセス、Zoom Mail、Zoom Calendar、Zoom Whiteboard ほか2件 | location inferred |
| Connect Jira to Workvivo to streamline project tracking and enhance team collaboration. | Jira と連携して、プロジェクトの進捗管理とチームの協働をスムーズに。 | location inferred |
| Connect to Jira and Confluence to streamline workflows and enhance team collaboration. | Jira と Confluence に連携して、ワークフローと協働を効率化。 | location inferred |
| Connect to ServiceNow to sync IT tickets, employee service requests, and workflows. | ServiceNow と連携して、ITチケットや各種申請、ワークフローを同期。 | location inferred |
| Connect to Workday to sync employee profiles, organizational data, and workforce information. | Workday と連携して、社員プロフィールや組織情報を同期。 | location inferred |
| Jump directly into your favorite Google apps and files with convenient, time-saving shortcuts. | よく使う Google アプリやファイルにショートカットからすぐアクセス。 | location inferred |
| Keep track of your schedule and events with ease using the Yahoo Calendar integration. | Yahoo カレンダー連携で予定やイベントを手軽に管理。 | location inferred |
| Quickly access Outlook, Teams, and other Microsoft 365 apps with a single click. | Outlook、Teams などの Microsoft 365 アプリにワンクリックでアクセス。 | location inferred |
| Securely share, manage, and collaborate on files with team members and external partners. | 社内外のメンバーと安全にファイルを共有・管理・共同編集。 | location inferred |
| Start or join meetings, share screens, and collaborate in real-time with this integration. | 会議の開始や参加、画面共有、リアルタイムの協働をこの連携から。 | location inferred |
| Sync your Apple Calendar to view events and schedules directly within the platform. | Apple カレンダーを同期して、予定をプラットフォーム内で確認。 | location inferred |

### WorkvivoAdminHub · frames 4553–4591 (3:02.1–3:03.6)
The admin hub landing screen.

| English | Japanese | |
|---|---|---|
| Surveys | サーベイ | location inferred |
| Quick Links | クイックリンク |  |
| Admin Hub | 管理ハブ |  |
| Admin Tools | 管理ツール |  |
| Search admin | 管理項目を検索 |  |
| Manage Favourites | お気に入りを管理 |  |
| Manage People | メンバー管理 | location inferred |
| Moderation | モデレーション | location inferred |
| Reported Content | 報告されたコンテンツ | location inferred |
| Products | プロダクト |  |
| Analytics | 分析 | location inferred |
| Campaigns | キャンペーン | location inferred |
| Workvivo TV | Workvivo TV | location inferred |
| Awards | 表彰 | location inferred |
| What's New | 新機能 |  |
| Bring company news and updates to every screen across your workplace. | 会社のニュースと最新情報を職場のあらゆる画面へ。 | location inferred |
| Capture feedback, understand sentiment, make informed decisions. | フィードバックを集め、社員の意識を把握し、根拠ある判断を。 | location inferred |
| Celebrate achievements and recognize great work across your organization. | 成果を称え、組織全体の優れた働きを認め合う。 | location inferred |
| Create engaging newsletters that keep everyone informed and connected. | 全員に情報が届き、つながりを保つニュースレターを。 | location inferred |
| Guide employees through personalized key workplace moments. | 職場の大切な節目を、一人ひとりに合わせて案内。 | location inferred |
| Measure engagement, uncover trends, and turn insights into action. | エンゲージメントを測り、傾向をつかみ、行動につなげる。 | location inferred |
| Plan, launch, and measure impactful internal communication campaigns. | 社内コミュニケーション施策を計画・実施・測定。 | location inferred |
| Turn insights into meaningful actions with AI-powered recommendations. | AIの提案で、インサイトを意味のある行動へ。 | location inferred |
...
|---|---|---|
| Governance | ガバナンス | location inferred |
| Homepage | ホームページ | location inferred |
| Smart Chapters | スマートチャプター | location inferred |
| Summarize with AI | AIで要約 | location inferred |
| Help Me Write | 書くのを手伝う | location inferred |
| Gauge Employee Sentiment | 社員の意識を測る | location inferred |
| Plan Future Improvements | 今後の改善を計画する | location inferred |
| Permissions | 権限 | location inferred |
| Granular Controls | きめ細かな制御 | location inferred |
| Powered by | 提供 |  |
| AI Compose | AIで作成 | location inferred |
| Book Time Off | 休暇を申請 | location inferred |
| Build eNPS Surveys | eNPSサーベイを作成 | location inferred |
| Create a Form | フォームを作成 | location inferred |
| Create a Survey | サーベイを作成 | location inferred |
| Gather Insights | インサイトを集める | location inferred |
| Localize Content | コンテンツをローカライズ | location inferred |
| Measure Engagement | エンゲージメントを測定 | location inferred |
| Monitor Performance | パフォーマンスを把握 | location inferred |
| Personalize Your Experience | 体験をパーソナライズ | location inferred |
| Spot Trends | 傾向をとらえる | location inferred |
...
| Go beyond | 数字の |  |
| the | 先へ。 | location inferred |
| numbers |  | location inferred |

### WorkvivoAdminCategories · appears in more than one scene
...
| Integrations | 連携 | location inferred |
| View more | もっと見る |  |
| Platform | プラットフォーム | location inferred |
| Features | 機能 | location inferred |
| Themes | テーマ | location inferred |
| Theming | テーマ設定 | location inferred |
| Localization | ローカライズ | location inferred |
| Timezone | タイムゾーン | location inferred |
| Provisioning | プロビジョニング | location inferred |
| API Keys & JWT Settings | APIキーとJWT設定 | location inferred |
| App Integrations | アプリ連携 | location inferred |
| Authentication Settings | 認証設定 | location inferred |
| Profile Banner Settings | プロフィールバナー設定 | location inferred |
| Space Approvals | スペースの承認 | location inferred |
| Space Content Promotion | スペースコンテンツの掲載 | location inferred |
| Video Subtitle Translations | 動画字幕の翻訳 | location inferred |
| Webhook Settings | Webhook設定 | location inferred |
| Zoom Configurations | Zoom 設定 | location inferred |
| People Manager | ピープルマネージャー | location inferred |
| Team Manager | チームマネージャー | location inferred |
...
| Brand Voice | ブランドボイス | location inferred |
| CEO Voice | CEOボイス | location inferred |
| Internal Comms | 社内広報 | location inferred |
...
### WorkvivoSeerInsights · appears in more than one scene
...
| June 10th, 2026 | 2026年6月10日 | location inferred |
| June 14th, 2026 | 2026年6月14日 | location inferred |
| June 15th, 2026 | 2026年6月15日 | location inferred |
| Seer AI | Seer AI |  |
| Driver | ドライバー | location inferred |
| Value | 価値観 | location inferred |
| Segment | セグメント | location inferred |
| NPS Category | NPSカテゴリ | location inferred |
| Topic | トピック | location inferred |
| Prescriptive | 提案 | location inferred |
| Starred | スター付き | location inferred |
...
| Negative | 悪い |  |
| Very Negative | とても悪い |  |
| Wellbeing | ウェルビーイング | location inferred |
| Career Development | キャリア開発 | location inferred |
| Team Collaboration | チームの協働 | location inferred |
| Work Environment | 職場環境 | location inferred |
| Employee Satisfaction | 従業員満足度 | location inferred |
| Workplace Atmosphere | 職場の雰囲気 | location inferred |
| Competitive Environment | 競争環境 | location inferred |
| Employee Morale | 社員の士気 | location inferred |
| Performance Recognition | 成果への評価 | location inferred |
| Coworker Relationships | 同僚との関係 | location inferred |
| Workplace Communication | 職場の情報共有 | location inferred |
| Team Dynamics | チームの力学 | location inferred |
| I can effectively manage my work-life balance | 仕事と生活のバランスをうまく保てている | location inferred |
| I am given real opportunities to grow here | ここには成長できる機会が実際にある | location inferred |
| Team meetings and communication are frequent and of high quality | チームの会議や情報共有は頻度も質も十分である | location inferred |
| I try my best to manage my work-life balance, but it can be challenging at times. | バランスを保つよう心がけていますが、難しく感じる時期もあります。 | location inferred |
| I've received great training over the last quarter | この四半期はとても良い研修を受けられました。 | location inferred |
| We haven't had a team meeting in a while. | しばらくチームで集まる機会がありません。 | location inferred |
| Neutral | どちらでもない |  |
| Communication | コミュニケーション | location inferred |

### WorkvivoSeerRater · appears in more than one scene
The rating / eNPS screen.

| English | Japanese | |
|---|---|---|
| Round 6 (2026/06/15) | 第6回（2026/06/15） |  |
| CX | CX | location inferred |
| Marketing | マーケティング | location inferred |
| Sales | 営業 | location inferred |
| Product | プロダクト | location inferred |
| Boston | 大阪 | location inferred |
| London | 東京 | location inferred |
| Location | 拠点 | location inferred |
| Department | 部門 | location inferred |
| All Segments | すべて | location inferred |
| Radar | レーダー | location inferred |
| Export CSV | CSVを書き出す |  |
| Wellbeing | ウェルビーイング | location inferred |
| My Job | 仕事内容 | location inferred |
| Culture and Values | 文化と価値観 | location inferred |
| Career Development | キャリア開発 | location inferred |
| Compensation and Benefits | 報酬と福利厚生 | location inferred |
| Senior Leadership | 経営層 | location inferred |
| Reward and Recognition | 評価と称賛 | location inferred |
| Empowerm... | 裁量… | location inferred |
...
|---|---|---|
| Close | 閉じる |  |
| Back | 戻る | overridden on timeoff |
| Previous | 前へ |  |
| Skip | スキップ |  |
| I am provided with the necessary tools and resources I need to do my job | 業務に必要なツールやリソースが十分に提供されている | location inferred |
| My manager gives me regular, helpful feedback on my work | 上司から自分の仕事について有益なフィードバックを定期的にもらえている | location inferred |
| I feel my contributions are recognized and valued by my team | 自分の貢献がチームに認められ、評価されていると感じる | location inferred |
| I have good opportunities for career growth and professional development | キャリアの成長と能力開発の機会が十分にある | location inferred |
| I would recommend our organization as a great place to work | 働きがいのある職場として、この組織を人に勧めたい | location inferred |
| Agree | そう思う | location inferred |
| Disagree | そう思わない | location inferred |
| Add Comment | コメントを追加 |  |
...
### WorkvivoSidebar · appears in more than one scene
...
### WorkvivoSpacePage · appears in more than one scene
...
| Q&A | Q&A | location inferred |
| FEATURED STORY | 注目のストーリー | location inferred |
| FEATURED PAGE | 注目のページ | location inferred |
| FEATURED PODCAST | 注目のポッドキャスト | location inferred |

### WorkvivoSurveyBuilder · appears in more than one scene
...
| Duplicate | 複製 |  |
| Delete | 削除 |  |
| Short Text | 短文 | location inferred |
| Paragraph | 長文 | location inferred |
| Multiple Choice | 選択式 | location inferred |
| Checkbox | チェックボックス | location inferred |
| Number Line | 数値スケール | location inferred |
| File Upload | ファイルアップロード | location inferred |
| Date and Time | 日付と時刻 | location inferred |
| Dropdown | ドロップダウン | location inferred |
| Contact Field | 連絡先フィールド | location inferred |
| Create a Survey or Form with Workvivo AI | Workvivo AI でサーベイやフォームを作成 |  |
| Create a fun survey | 楽しいサーベイ | location inferred |
| Gauge employee sentiment | 社員の意識を測る | location inferred |
| Plan future improvements | 今後の改善を計画する | location inferred |
| Gather insights on trends | 傾向のインサイトを集める | location inferred |
...
| English | Japanese |
|---|---|
| Communication & Engagement | コミュニケーションと エンゲージメント |
...
| Experiences | 体験 |
| Rachel Lopez | 三浦 恵子 |
| We're sharing our latest insights and updates on the actions being taken based on the feedback we've received last week. This document highlights key themes, opportunities, and the steps we're taking to continue improving the employee experience. Thank you to everyone who continues to share their perspectives! Your feedback helps guide meaningful change and shape the future of our organization 👏 | 先週いただいたフィードバックをもとに進めている取り組みと、最新のインサイトを共有します。この資料では、主なテーマ、改善の機会、そして社員エクスペリエンスをさらに良くするためのステップをまとめました。声を寄せ続けてくださる皆さんに感謝します。皆さんのフィードバックが、意味のある変化と組織の未来を形づくります 👏 |
...
| `livestream.comments[6].name` | 山田 悠人 |
...
| `stories[0].body` | 年次「社員体験サミット」まで、あと19日となりました。世界中のチームが一堂に会し、新しい働き方を探り、共通のビジョンのもとでつながり、これからの社員体験を形づくります。 |
...
| `composed.body` | 佐藤 美咲さん、ウェルビーイングの取り組みをご牽引いただきありがとうございます。その働きが、組織全体の健やかな職場づくりを支えています 💜 |
| `person.name` | 田中 陽子 |
...
| `spaces.page.about` | 今年の年次社員サミットのページへようこそ。アジェンダ、交通・宿泊のご案内、登壇者情報、よくある質問、ライブ配信の詳細、当日の資料まで、開催前に必要な情報をまとめています。 |
| `spaces.page.survey.title` | 社員サミット 交通手配サーベイ |
...
| `spaces.page.featured.page` | 交通・宿泊のご案内 |
...
| `spotlight.event.when` | 2026年8月13日（木）<br>17:00 - 20:30 |
