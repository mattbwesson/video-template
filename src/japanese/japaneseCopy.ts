...
const PATCH = {
  ...
  stories: [
    {
      title: "カウントダウン開始 ⏱️",
      body:
        "年次「従業員体験サミット」まで、あと19日となりました。世界中のチームが一堂に会し、" +
        "新しい働き方を探り、共通のビジョンのもとでつながり、これからの従業員体験を形づくります。",
    },
    {
  ...
  composed: {
    ...
    value: "思いやりを大切に",
    body:
      "佐藤 美咲さん、ウェルビーイングの取り組みを牽引いただきありがとうございます。" +
