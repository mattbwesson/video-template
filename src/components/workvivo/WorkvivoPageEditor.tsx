...
export const Spark: React.FC<{ size?: number; color?: string; style?: React.CSSProperties }> = ({
  ...
  /* The caller's placement goes on a wrapper, never on the svg root — see PlacedSvg. */
  <PlacedSvg style={style} box={{ width: size, height: size }}>
    {(svgStyle) => (
      <svg viewBox="0 0 24 24" width={size} height={size} style={svgStyle} xmlns="http://www.w3.org/2000/svg">
